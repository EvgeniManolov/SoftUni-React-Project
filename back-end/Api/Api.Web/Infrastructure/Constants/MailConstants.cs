namespace Api.Web.Infrastructure.Constants
{
    public static class MailConstants
    {
        ...
        public const string ContentConfirm = "Здравейте," + "\n" + "Вашата поръчка в ... беше потвърдена и ще бъде изпратена на посочения от Вас адрес/офис на Еконт." + "\n" + "Благодарим Ви, че пазарувахте от нас!";

        public const string ContentCancel = "Здравейте," + "\n" + "Вашата поръчка в ... беше отказана" + "\n" + "Заповядайте отново!";

        public const string ContactFormMailContent = "Имейл: {0}" + "\n" + "Име: {1}" + "\n" + "Съдържание: {2}";

        public const string OfficeMail = "evg_manolov@abv.bg";

        public const string DebugMail = "evg_manolov@abv.bg";
    }
}
